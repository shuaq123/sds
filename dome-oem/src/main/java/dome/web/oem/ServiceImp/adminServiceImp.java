...
//        List<admin> countAdmin = AdminMappere.select(c);
...
//        admin d = new admin();
//        d.setUsername(a.getMoblie());
//        List<admin> user = AdminMappere.select(d);
...
//
//        admin Admin = AdminMappere.selectByPrimaryKey(adminid);
//        a.setId(adminid);
//
//        int code = AdminMappere.updateByPrimaryKey(a);
//
...
//            adminRoleLink a = new adminRoleLink();
//            a.setAdminid(Am.getId());
//            List<adminRoleLink> roleList = AdminRoleLinkMapper.select(a);
//            List<Integer> roleArr = roleList.stream().map(s->s.getRoleid()).collect(Collectors.toList());
//            for (Integer r:roleArr){
//                adminRole rl = AdminRoleMapper.selectByPrimaryKey(r);
...
//        int a= AdminMappere.deleteByPrimaryKey(adminid);
//
//        if (a>0){
//            QueryWrapper<adminRoleLink> delt = new QueryWrapper<>();
//            delt.eq("adminId",adminid);
//            adminRoleLink b = new adminRoleLink();
//            b.setAdminid(adminid);
//            AdminRoleLinkMapper.delete(b);
//
//            return "删除成功";
//        }
//        return "删除失败";
